...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <h1 class="page-header">Edit Course  <a href="{{url('/course')}}/{{$course->course_slug}}" target="_blank"><button type="button" class="btn float-right btn-warning">Go to Course</button></a></h1>
        <style>
            .float-right {
        ...
        <form method="POST" action="{{route('admin.courses.update', $course->id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br>
                <img src="{{url('/images/courses')}}/{{ $course->course_image }}" height="100"/>
